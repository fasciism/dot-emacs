...
#+begin_src emacs-lisp
  (use-package undo-tree
    ...
    (undo-tree-history-directory-alist `(("." . ,(expand-file-name "undo-tree-history" state-emacs-directory)))))
#+end_src
...
#+begin_src emacs-lisp
  (let ((dir (assoc-default "." undo-tree-history-directory-alist)))
    (make-directory dir t)
    (write-region "" nil (expand-file-name "ALL-FILES-IN-THIS-DIRECTORY-ARE-HIDDEN" dir)))
#+end_src
